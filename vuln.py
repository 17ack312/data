...
def display(r):
    r1=r.split('\t')[0]
    r2=r.split('\t')[-1]
    r3=r2.split(']',1)[0].strip()
    r4=r2.split(']',1)[-1].strip()

    if '[INFO]' in r:
        #print("\t",style.on_cyan(style.black(" "+str(r1)+" ")),"\t",style.cyan(str(r2)))
        print("\t",style.on_cyan(style.black(" "+str(r1)+" ")),"\t",style.on_cyan(" "+str(r3)+"] "),style.cyan(" "+str(r4)+" "))
    if '[LOW] ' in r:
        #print("\t",style.on_green(style.black(" "+str(r1)+" ")),"\t",style.green(str(r2)))
        print("\t",style.on_green(style.black(" "+str(r1)+" ")),"\t",style.on_green(" "+str(r3)+"]  "),style.green(" "+str(r4)+" "))
    if '[MED]' in r:
        #print("\t",style.on_yellow(style.black(" "+str(r1)+" ")),"\t",style.yellow(str(r2)))
        print("\t",style.on_yellow(style.black(" "+str(r1)+" ")),"\t",style.on_yellow(" "+str(r3)+"]  "),style.yellow(" "+str(r4)+" "))
    if '[HIGH]' in r :
        #print("\t",style.on_light_red(style.black(" "+str(r1)+" ")),"\t",style.light_red(str(r2)))
        print("\t",style.on_light_red(style.black(" "+str(r1)+" ")),"\t",style.on_light_red(" "+str(r3)+"] "),style.light_red(" "+str(r4)+" "))
    if '[CRIT]' in r:
        #print("\t",style.on_red(style.black(" "+str(r1)+" ")),"\t",style.red(str(r2)))
        print("\t",style.on_red(style.black(" "+str(r1)+" ")),"\t",style.on_red(" "+str(r3)+"] "),style.red(" "+str(r4)+" "))
    ...
    for i in data.keys():
        if 'script' in (data[i].keys()) and str(data[i]['state'])=='open':
            ...
            for j in (data[i]['script'].keys()):
                ...
                if not re.search('Script execution failed',str(script),re.IGNORECASE):
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::: S S H :::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
                    #1              
                    if str(j)=='sshv1':
